<div class="row">
    <div class="col-12">
        <label for="genealogia" class="form-label" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#form4-container"><strong class="me-2">por Genealogia</strong><i class="fa-solid fa-caret-down"></i></label>
    </div>

    <!-- PAI -->
    <div class="collapse" id="form4-container">
        <div class="row">
            <div class="col-6">
