<div class="row">
    ...
    <div class="col-4">
        <div class="mb-3">
            <label for="rp" class="form-label">Reprodução Programada</label>
            <select class="form-select form-select-sm filter-input" id="rp" aria-label="Selecione a Raça" name="rp">
                <option selected></option>
